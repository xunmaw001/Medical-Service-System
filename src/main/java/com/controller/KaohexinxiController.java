...
public class KaohexinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,KaohexinxiEntity kaohexinxi, HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xiangcunyisheng")) {
			kaohexinxi.setZhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,KaohexinxiEntity kaohexinxi, HttpServletRequest request){
        EntityWrapper<KaohexinxiEntity> ew = new EntityWrapper<KaohexinxiEntity>();
		PageUtils page = kaohexinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, kaohexinxi), params), params));
        return R.ok().put("data", page);
    }
